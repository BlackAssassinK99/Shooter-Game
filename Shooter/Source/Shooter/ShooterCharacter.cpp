...

{
	...
	CameraBoom->TargetArmLength = 150.f; // the camera follows at this distance behind th character
...
void AShooterCharacter::FireWeapon()
{
	...
	// Start Bullet Fire timerfor crosshairs
...
void AShooterCharacter::CalculateCrosshairSpread(float DeltaTime)
{
	...
	if (bFiringBullet)
	{
		CrosshairSchootingFactor = FMath::FInterpTo(CrosshairSchootingFactor, 0.3f, DeltaTime, 60.f);
	}
	else
	{
		CrosshairSchootingFactor = FMath::FInterpTo(CrosshairSchootingFactor, 0.f, DeltaTime, 60.f);
	}

	CrosshairSpreadMultiplier = 0.5f + CrosshairVelocityFactor + CrosshairInAirFactor + CrosshairAimFactor + CrosshairSchootingFactor;
}
...
{
	// Check the TSubclasssOf variable
...
void AShooterCharacter::Tick(float DeltaTime)
{
	...
	// Handle Interpolation for zoomed when aiming
